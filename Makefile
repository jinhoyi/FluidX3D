...
GENERATED_FILES = \
	./src/openFluid/openrtist_pb2.py
...
src/openFluid/openrtist_pb2.py: src/proto/openrtist.proto .venv
	.venv/bin/python3 -m grpc_tools.protoc --python_out=socketServer -I src/proto openrtist.proto
	/usr/bin/protoc -I=./src/proto -I=./src/proto/include --cpp_out=src/proto gabriel.proto
	/usr/bin/protoc -I=./src/proto -I=./src/proto/include --cpp_out=src/proto openrtist.proto
