...
#define SIM_PER_SEC 300
#define TIME_INTERVAL 3000 // micro second (SIM_PER_SEC Framse per sec)
...
#define GRAPHICS_FRAME_HEIGHT 640 // set frame height if only GRAPHICS is enabled
...
// #define GRAPHICS_TRANSPARENCY 0.000000000000000001f // optional: comment/uncomment this line to disable/enable semi-transparent rendering (looks better but reduces framerate), number represents transparency (equal to 1-opacity) (default: 0.7f)
...
#define GRAPHICS_RAYTRACING_TRANSMITTANCE 0.75f // transmitted light fraction in raytracing graphics ("0.25f" = 1/4 of light is transmitted and 3/4 is absorbed along longest box side length, "1.0f" = no absorption)
// #define GRAPHICS_RAYTRACING_COLOR 0x005F7F // absorption color of fluid in raytracing graphics
// #define GRAPHICS_RAYTRACING_COLOR 0xEBA937 // Honey
// #define GRAPHICS_RAYTRACING_COLOR 0xd59938 // gold
#define GRAPHICS_RAYTRACING_COLOR 0xFFFFFF // Water
